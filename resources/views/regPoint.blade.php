...
<div class="header_form pt-5 pt-md-0 pb-3">
   <h3 class="header_form_title d-none d-md-block">@lang('string.reg_public_institution')</h3>
   <h4 class="header_form_title d-block d-md-none">@lang('string.reg_public_institution')</h4>
</div>
<div class="container-fluid mt-n3 mt-md-n5 pb-4 px-0 d-flex justify-content-center">
   <form action="{{route('savePoint')}}" method="POST" enctype="multipart/form-data" class="col-md-10 col-lg-8 p-2 p-md-4 form_reg shadow border needs-validation" novalidate>
      {{ csrf_field() }}
      <div class="py-3">
         ...
         <div class="sub_title_bg pt-4 px-2 px-sm-3 pb-2 pb-sm-3">
            <div class="form-row d-flex justify-content-center">
               <div class="form-group col-12">
                  ...
                  <input type="text" name="name_place" id="name_place" class="form-control" placeholder="@lang('string.enter_name')" maxlength="200" required>
      ...
      <div class="py-3">
         ...
         <div class="sub_title_bg pt-4 px-2 px-sm-3 pb-2 pb-sm-3">
            <div class="form-group col-12">
               ...
               <input type="url" name="atp_url" id="atp_url" class="form-control" placeholder="@lang('string.enter_webpage')" maxlength="200">
