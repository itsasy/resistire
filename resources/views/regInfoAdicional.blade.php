      ...
      <form action="{{route('saveInfo')}}" method="POST" enctype="multipart/form-data"
          ...
          <div class="subarea_reg rounded_1 pt-4 px-2 px-sm-3 pb-2 pb-sm-3">
            <div class="form-row d-flex justify-content-center">
              <div class="form-group col-lg-12">
                ...
                <input type="text" name="adi_title" id="adi_title" class="form-control rounded_1"
              ...
              <div class="form-group col-lg-6">
                ...
                <input type="date" name="adi_date " id="adi_date" class="form-control rounded-custom_1" required>
                <div class="invalid-feedback">Seleccione la fecha</div>
                <div class="valid-feedback">Fecha seleccionada</div>
              </div>
              <div class="form-group col-lg-6">
                <label for="hora">Hora</label>
                <input type="time" name="hora" id="hora" class="form-control rounded-custom_1" required>
          ...
          <div class="subarea_reg rounded_1 pt-4 px-2 px-sm-3 pb-2 pb-sm-3">
            <div class="form-row">
              <div class="form-group col-lg-6">
                ...
                <input type="text" name="adi_source" id="adi_source" class="form-control rounded_1"
              ...
              <div class="form-group col-lg-6">
                ...
                <input type="adi_url" name="adi_url" id="adi_url" class="form-control rounded_1"
          ...
          <div class="subarea_reg rounded_1 pt-4 px-2 px-sm-3 pb-2 pb-sm-3">
            <div class="form-row">
              <div class="form-group col-lg-6">
                ...
                <input type="adi_youtube" name="adi_youtube" id="adi_youtube" class="form-control rounded_1"
              ...
              <div class="form-group col-lg-6">
                ...
                <input type="adi_instagram" name="adi_instagram" id="adi_instagram" class="form-control rounded_1"
              ...
              <div class="form-group col-lg-6">
                ...
                <input type="adi_facebook" name="adi_facebook" id="adi_facebook" class="form-control rounded_1"
        ...
        <div class="form-row justify-content-center">
          <div class="form-group col-lg-4 d-flex">
            <a name="" id="" class="btn btn_circl_outl_p rounded-circle mr-2" href="{{route('noticias', ['seccion'=> "adicional"])}}" role="button"><i class="fas fa-times"></i></a>
