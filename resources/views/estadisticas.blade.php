   ...
   <div class="col">
      <div class="card shadow mb-3">
         ...
         <div class="card-body">
            ...
            <h4 class="small font-weight-bold">{{$contar->info_district->dst_name}}<span class="float-right">{{$contar->total}}</span></h4>
            <div class="progress mb-4">
               <div class="progress-bar bg_p" style="width:{{$contar->total}}px" role="progressbar" aria-valuenow="{{$contar->total}}" aria-valuemin="0"></div>
            </div>
            @endforeach
         </div>
      </div>
