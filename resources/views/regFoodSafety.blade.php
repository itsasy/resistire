...
<div class="header_form pt-5 pt-md-0 pb-3">
   <h3 class="header_form_title d-none d-md-block">@lang('string.reg_food_safety')</h3>
   <h4 class="header_form_title d-block d-md-none">@lang('string.reg_food_safety')</h4>
</div>
<div class="container-fluid mt-n3 mt-md-n5 pb-4 px-0 d-flex justify-content-center">
   <form action="{{route('alimentos.store')}}" method="POST" enctype="multipart/form-data" class="col-md-10 col-lg-8 p-2 p-md-4 form_reg shadow border needs-validation" novalidate>
      {{ csrf_field() }}
      <div class="py-3">
         ...
         <div class="sub_title_bg pt-4 px-2 px-sm-3 pb-2 pb-sm-3">
            <div class="form-row d-flex justify-content-center">
               <div class="form-group col-md-6">
                  ...
                  <input type="text" name="fds_title" id="fds_title" class="form-control" placeholder="@lang('string.enter_title')" maxlength="200" required>
               ...
               <div class="form-group col-12">
                  ...
                  <textarea name="fds_desc" id="fds_desc" class="form-control form-control_textarea_md rounded_1" placeholder="@lang('string.enter_description')" maxlength="500" required></textarea>
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" name="fds_source" id="fds_source" class="form-control" placeholder="@lang('string.enter_source')" maxlength="200" required>
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="date" name="fds_date" id="fds_date" class="form-control" placeholder="@lang('string.select_date')" maxlength="200" required>
         ...
         <div class="sub_title_bg pt-4 px-2 px-sm-3 pb-2 pb-sm-3">
            <div class="form-row">
               <div class="form-group col-lg-6">
                  ...
                  <input type="url" name="fsd_instagram" id="fsd_instagram" class="form-control" placeholder="@lang('string.enter_instagram')" maxlength="200">
               ...
               <div class="form-group col-lg-6">
                  ...
                  <input type="url" name="fsd_facebook" id="fsd_facebook" class="form-control" placeholder="@lang('string.enter_facebook')" maxlength="200">
               ...
               <div class="form-group col-lg-6">
                  ...
                  <input type="url" name="fsd_youtube" id="fsd_youtube" class="form-control" placeholder="@lang('string.enter_youtube')" maxlength="200">
               ...
               <div class="form-group col-lg-6 ">
                  ...
                  <input type="url" name="fsd_url" id="fsd_url" class="form-control" placeholder="@lang('string.enter_webpage')" maxlength="200">
