         ...
         <div class="sub_title_bg pt-4 px-2 px-sm-3 pb-2 pb-sm-3">
            <div class="form-row">
               <div class="form-group col-lg-6">
                  ...
                  <input type="url" name="fds_instagram" id="fds_instagram" class="form-control" placeholder="@lang('string.enter_instagram')" maxlength="200">
               ...
               <div class="form-group col-lg-6">
                  ...
                  <input type="url" name="fds_facebook" id="fds_facebook" class="form-control" placeholder="@lang('string.enter_facebook')" maxlength="200">
               ...
               <div class="form-group col-lg-6">
                  ...
                  <input type="url" name="fds_youtube" id="fds_youtube" class="form-control" placeholder="@lang('string.enter_youtube')" maxlength="200">
               ...
               <div class="form-group col-lg-6 ">
                  ...
                  <input type="url" name="fds_url" id="fds_url" class="form-control" placeholder="@lang('string.enter_webpage')" maxlength="200">
