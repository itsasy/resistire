                ...
                <div class="py-3">
                    ...
                    <div class="subarea_reg rounded_1 pt-4 px-2 px-sm-3 pb-2 pb-sm-3">
                        <div class="form-row d-flex justify-content-center">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <select name="cmp_id_cmpt" class="form-control rounded_1" required>
                                    <option <?php if($companie->cmp_id_cmpt =='1') echo "selected";?> value="1">Hospital
                                    </option>
                                    <option <?php if($companie->cmp_id_cmpt =='2') echo "selected";?> value="2">
                                        Comisaria</option>
                                    <option <?php if($companie->cmp_id_cmpt =='3') echo "selected";?> value="3">CEM
                                    </option>
                                    <option <?php if($companie->cmp_id_cmpt =='4') echo "selected";?> value="4">Mercados
                                    </option>
                                    <option <?php if($companie->cmp_id_cmpt =='5') echo "selected";?> value="5">
                                        Restaurantes</option>
                                </select>
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="text" name="address_place" id="address_place"
                                    class="form-control rounded_1" placeholder="Ingrese la dirección" required
                                    value="{{$companie->cmp_address}}">
                            ...
                            <div class="subarea_reg rounded_1 pt-4 px-2 px-sm-3 pb-2 pb-sm-3">
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="url" name="cmp_instagram" id="cmp_instagram"
                                            class="form-control rounded_1" value="{{$companie->cmp_instagram}}">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="url" name="cmp_facebook" id="cmp_facebook"
                                            class="form-control rounded_1" value="{{$companie->cmp_facebook}}">
                                        <div class="invalid-feedback">Dirección incorrecta</div>
                                        <div class="valid-feedback">Dirección correcta</div>
                                    </div>
                                    <div class="form-group col-lg-6 ">
                        ...
                        <div class="form-row">
                            <div class="col">
                                <p
                                    class="font-weight-bold text-secondary text-center py-2 px-3 mt-n3 bg-white rounded_1 text-center">
                        ...
                        <div class="d-none">
                            <input type="text" name="cmp_latitude" id="latitude_place"
                                value="{{$companie->cmp_latitude}}">
                            <input type="text" name="cmp_longitude" id="length_place"
                                value="{{$companie->cmp_longitude}}">
                        </div>
